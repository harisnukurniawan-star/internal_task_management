...
type TaskSearchParams = FlashParams & { edit?: string };
      ...
      {editTask ? (
        <section className="card compact section" id="edit-task">
          <div className="card-head">
            ...
            <a className="btn secondary" href="/tasks">Batal</a>
          </div>
                  ...
                  <td style={{ textAlign: "center", position: "relative" }}>
                    <details style={{ position: "relative", display: "inline-block" }}>
                      ...
                      <div style={{
                        ...
                        {editable ? (
                          <a
                            href={`/tasks?edit=${task.id}#edit-task`}
