  ...
  return (
    <main className="login">
      <section className="login-card">
        ...
        <p className="muted small">Belum pernah aktivasi? Gunakan <a href="/activate-account">Aktivasi Akun</a> terlebih dahulu. Reset password hanya berlaku untuk akun Auth yang sudah terbentuk.</p>
